...
<section class="wp-block [&_.wp-element-button::before]:content-[''] [&_.wp-element-button::before]:inset-0 [&_.wp-element-button::before]:absolute group relative my-12 {{ $block->block->align === 'full' ? 'alignfull px-4' : 'alignwide' }} {{ $animate ? 'animate-reveal-scope' : '' }}">
