                ...
                @if ($cards)
                    <ul class="mx-auto mt-12 flex max-w-6xl list-none flex-col gap-8 p-0">
                        @foreach ($cards as $card)
                            <li
                                class="flex group flex-col relative gap-6 rounded-xl border-2 border-yellow-dark bg-white p-6 text-black sm:p-10 lg:items-center lg:gap-16 {{ $loop->even ? 'lg:flex-row-reverse' : 'lg:flex-row' }}">
                                <div class="flex-1">
